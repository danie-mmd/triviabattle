...
async function run() {
    ...
    const url = `https://toncenter.com/api/v2/getTransactions?address=EQDuTzpqHKV3FBT3-xGgeN6H_Qpn0ZSFQ5aiADjD3ssDrBGE&hash=${encodeURIComponent(hash)}&lt=${lt}&limit=1`;
