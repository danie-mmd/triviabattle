...
export function storeReset(src: Reset) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(666145064, 32);
        b_0.storeStringRefTail(src.newRoomId);
    };
}

export function loadReset(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 666145064) { throw Error('Invalid prefix'); }
    const _newRoomId = sc_0.loadStringRefTail();
    return { $$type: 'Reset' as const, newRoomId: _newRoomId };
}

export function loadTupleReset(source: TupleReader) {
    const _newRoomId = source.readString();
    return { $$type: 'Reset' as const, newRoomId: _newRoomId };
}

export function loadGetterTupleReset(source: TupleReader) {
    const _newRoomId = source.readString();
    return { $$type: 'Reset' as const, newRoomId: _newRoomId };
}

export function storeTupleReset(source: Reset) {
    const builder = new TupleBuilder();
    builder.writeString(source.newRoomId);
    return builder.build();
}

export function dictValueParserReset(): DictionaryValue<Reset> {
    return {
        serialize: (src, builder) => {
...
async function Escrow_init(authorizedBackend: Address, roomId: string, entryFeeNano: bigint) {
    const __code = Cell.fromHex('');
...
const Escrow_types: ABIType[] = [
    ...
    {"name":"Reset","header":666145064,"fields":[{"name":"newRoomId","type":{"kind":"simple","type":"string","optional":false}}]},
...
const Escrow_getters: ABIGetter[] = [
    ...
    {"name":"authorizedBackend","methodId":77654,"arguments":[],"returnType":{"kind":"simple","type":"address","optional":false}},
...
export const Escrow_getterMapping: { [key: string]: string } = {
    ...
    'authorizedBackend': 'getAuthorizedBackend',
    'roomId': 'getRoomId',
}
...
export class Escrow implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: Deposit | Payout | Refund | WithdrawDust | Reset | Deploy) {
    ...
    async getAuthorizedBackend(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('authorizedBackend', builder.build())).stack;
